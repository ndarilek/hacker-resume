...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "rnyps5jvq2ajpjc4wfzu98nn6w89w85ntdu6ahxs7pdgng76vwqh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Hacker Resume"),
    ...
    metadata = (
      ...
      website = "https://github.com/ndarilek/hacker-resume",
      # This should be the app's main website url.

      codeUrl = "https://github.com/ndarilek/hacker-resume",
      ...
      categories = [productivity, webPublishing],
      ...
      shortDescription = (defaultText = "Markdown resume builder"),
      ...
      screenshots = [
        ...
        (width = 1921, height = 963, png = embed "../screenshot.png")
      ],
